...
import { Link2, ExternalLink, Loader2, BarChart3, TrendingUp, Clock, Trash2, Copy, Share2, Image } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 animate-gradient-x">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* URL Input Form */}
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 mb-12 transform hover:shadow-2xl transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {shortenedUrls.length > 0
                    ? Math.round(
                        shortenedUrls.reduce((sum, url) => sum + (url.Clicks || 0), 0) / shortenedUrls.length
                      )
                    : 0}
                </p>
              </div>
                      ...
                      <div className="flex items-center gap-4 flex-1">
                        <div className="w-12 h-12 rounded-lg bg-white shadow-md flex items-center justify-center overflow-hidden">
                          {getFaviconUrl(item.LongUrl) ? (
                            <img
                              src={getFaviconUrl(item.LongUrl)}
                              alt="Website favicon"
